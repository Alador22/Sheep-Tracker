...
function Sau({ handleRefresh }) {
  ...
  const navigateToSheep = (sheepId) => {
    if (sheepId) {
      navigate(`/Sau/${sheepId}`);
    }
  };
    ...
    <div className="page">
      <div className="sau-container">
        ...
        {Object.entries(formData).map(([key, value]) => {
          ...
          const isParentKey = key === "father" || key === "mother";
          const displayValue = key === "dead" && !value ? "Nei" : value;
