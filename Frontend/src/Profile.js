...
function Profile() {
    ...
    const handleEmailChange = (e) => {
        ...
        axios.post('http://localhost:5000/user/profile', { email, currentPassword })
    ...
    const handlePasswordChange = (e) => {
        ...
        axios.post('http://localhost:5000/user/profile', { newPassword, currentPassword })
    ...
    const handleAccountDeletion = (e) => {
        ...
        if (window.confirm('Are you sure you want to delete your account? This action cannot be undone.')) {
            ...
            axios.post('http://localhost:5000/user/profile', { currentPassword })
                .then(response => {
